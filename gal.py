...
monitored_launch = ['pypy gts.py all y run_once get_default_config score_only',\ #updates the default config scores
'pypy gts.py 1 y run_once get_config',\#searches quartile 1 of a randomly selected config
'pypy gts.py 2 y run_once get_config',\#searches quartile 2 of a randomly selected config
'pypy gts.py 3 y run_once get_config',\#searches quartile 3 of a randomly selected config
'pypy gts.py 4 y run_once get_config',\#searches quartile 4 of a randomly selected config
'pypy gts.py all y run_once get_config',\#searches all quartiles of a randomly selected config
'pypy gts.py all y run_once get_default_config']#searches all quartiles of the default config
